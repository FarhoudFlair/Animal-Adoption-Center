#include "include/addclientcontrol.h"

AddClientControl::AddClientControl()
{

}

void AddClientControl::launch(Ui::MainWindow *ui)
{
    Client dummy;
    this->setClientForm(ui, dummy);
    ui->clientsStackedWidget->setCurrentWidget(ui->clientFormPage);
}


void AddClientControl::setClientForm(Ui::MainWindow *ui, Client &c, bool e)
{
